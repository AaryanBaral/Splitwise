...
namespace Splitwise_Back.Models
{
    public class ExpenseShare
    {
        ...
        public Expense? Expense { get; set; } // Navigation Property to Expense

        public required string UserId { get; set; } // Foreign Key to Users Table
        public CustomUser? User { get; set; } // Navigation Property for User who owes a portion
        public required string OwesUserId { get; set; }  // Foreign Key to User table (the one who is owed money)
        public CustomUser? OwesUser { get; set; }  // Navigation property
