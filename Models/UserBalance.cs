...
namespace Splitwise_Back.Models
{
    public class UserBalance
    {
        ...
        public required IdentityUser User { get; set; } // Navigation Property for User who owes
        public required string OwedToUserId { get; set; } // Foreign Key to Users Table (the user who is owed)
        public required IdentityUser OwedToUser { get; set; } // Navigation Property for User who is owed
